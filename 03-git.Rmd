...
- We then start off by registering a github account at https://github.com
- Use your github user name and email to config git. Open a Shell/Command line window from RStudio menu **Tools/Shell...**, and run the following commands:
```{r, eval=FALSE}
...
- Let's turn the RStudio project you have been working on into a git repository and commit it to github http://happygitwithr.com/existing-github-last.html
