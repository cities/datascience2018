...
1. Overview and Introduction
    1. Install the latest [R](https://ftp.osuosl.org/pub/cran/) and [RStudio Desktop](https://www.rstudio.com/products/rstudio/download/) free version
    1. R teasers: 
    ...
    1. Code Style Guide
        ...
        1. [Hadley Wickham's code style guide](http://adv-r.had.co.nz/Style.html)
1. R Coding Basics
    ...
    1. [Debugging with RStudio](http://www.milanor.net/blog/visual-debugging-with-rstudio/)
...
1. Version Control with Git
    ...
    1. [Software Carpentry Git lesson](http://swcarpentry.github.io/git-novice/)
    1. [try Git](https://try.github.io)
1. Creating R Package
