...
If you don't have a feasible project idea at the moment, consider writing a R package that visualizes the bike counts on Hawthorne and Tilikum. Daily traffic counts data for these two bridges can be found [here](https://github.com/cities/datascience2017/tree/master/data). At the minimum, your package should be able to:
