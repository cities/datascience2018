...
1. With the NHTS2009 travel diaries data, how do you cacluate total miles traveled and miles traveled by driving for each household (hint: the TRPMILES column contains information of trip distance for each member of a household).
